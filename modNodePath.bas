Attribute VB_Name = "modNodePath"
Public Function f_ReturnNodePath(str_TreeView1Path As String) As String
    ...
    If int_Search%(1) > 0 Then
        f_ReturnNodePath$ = str_RootPath$ & Mid(str_TreeView1Path$, int_Search%(1) + 1, Len(str_TreeView1Path$)) & "\"
    End If
