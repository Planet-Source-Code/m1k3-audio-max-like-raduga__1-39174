Attribute VB_Name = "modGetCDA"
Option Explicit
           
Public Sub subCDAList(oFileList As ListBox, oTreeView As TreeView, sFolderPath As String, vParentID As Variant)
